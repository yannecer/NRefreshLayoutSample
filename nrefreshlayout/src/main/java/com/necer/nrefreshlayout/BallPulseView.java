...
public class BallPulseView extends View {
    ...
    public BallPulseView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        circleSpacing = dp2px(getContext(), 4);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int default_size = (int) dp2px(getContext(), DEFAULT_SIZE);
    ...
    protected void onAttachedToWindow() {
       ...
       // MyLog.d("protectedprotectedprotectedprotected:::;1111");
...
//        MyLog.d("protectedprotectedprotectedprotected:::;222221");
